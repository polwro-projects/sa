...
void Application::Start()
{
    ...
    for (const auto& section : parameters_.sections)
    {
        ...
        {
            tsp::algorithm::SA tsp{ positions, std::stof(section.properties.at("temperature")),
                                    std::stof(section.properties.at("multiplier")),
                                    std::stoi(section.properties.at("epoch_size")) };
